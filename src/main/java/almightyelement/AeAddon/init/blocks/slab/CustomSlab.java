...
*/
public CustomSlab(final Material material, final SlabGroup<VARIANT, VARIANTS, SLAB> slabGroup, final VARIANTS variants) {
super(material);
...
setCreativeTab(ModClass.kryptonitetab);
}
